...
class gradingform_frubric_controller extends gradingform_controller {
    ...
    /**
     * Get outcomes, if any, for the course
     */
    ...
    public function update_or_check_frubric(stdClass $newdefinition, $usermodified = null, $doupdate = false) {
        ...
        $criteriafields      = array('sortorder', 'description', 'descriptionformat', 'outcomeid');
        ...
        foreach ($newcriteria as $i => &$criterion) {
            ...
            if ($criterion->status == "NEW" || ($criterion->status == "DELETE" &&  strpos($criterion->cid, 'NEWID') != false)) {
                ...
                $data = array('definitionid' => $this->definition->id, 'descriptionformat' => FORMAT_MOODLE, 'outcomeid' => 0);
    ...
    protected function load_definition() {
        ...
        foreach ($rs as $record) {
            ...
            if (!empty($record->rcid) && empty($this->definition->frubric_criteria[$record->rcid])) {
                foreach (array('id', 'sortorder', 'description', 'descriptionformat', 'outcomeid') as $fieldname) {
...
class gradingform_frubric_instance extends gradingform_instance {
        ...
        $frubriccriteria = new external_multiple_structure(
            new external_single_structure(
                array(
                    ...
                    'outcomeid' => new external_value(PARAM_RAW, 'outcomeid', VALUE_OPTIONAL),
    ...
    public function get_grade() {
        ...
        // A suitable place to inject/save outcome grades.
        // Test: http://moodle4.local/mod/assign/view.php?id=386&action=grader&userid=3
        // Trigged on save.
        /*global $DB;
